...
- Supervisor crea sesión en PC; contadores entran desde el celular.
- Cada contador ve **su vista independiente** (no la del compañero durante el conteo).
- Carga líneas con desglose por ubicación dentro del sector.
- Al cerrar sector por ambos: comparación automática.
- Si hay diferencia: **reconteo** solo de esos productos, con desglose anterior visible.
...
| Tiempo real | **WebSockets** para inventario dual (fase posterior) |
