...
/** Evita doble clic seguido. Solo debounce corto — ya no usamos api.github.com. */
...
function friendlyUpdateError(err: unknown): string {
  ...
  if (/\b429\b|Too Many Requests|rate limit exceeded/i.test(message)) {
    return 'GitHub está ocupado un momento. Probá de nuevo en unos segundos, o instalá el Setup a mano desde Releases.'
  }
